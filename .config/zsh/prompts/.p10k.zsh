# Generated by Powerlevel10k configuration wizard on 2020-08-10 at 12:38 CEST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 56284.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# 24h time, slanted separators, round heads, blurred tails, 2 lines, solid, full frame,
...
() {
  ...
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX='%240F╰─ %76F$'
